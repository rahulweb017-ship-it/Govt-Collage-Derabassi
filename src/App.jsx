...
import LatestSyllabusPage from './pages/LatestSyllabusPage'
    ...
    <Router>
      ...
      <Layout>
        <Routes>
          ...
          <Route path="/academics/syllabus" element={<LatestSyllabusPage />} />
          <Route path="/syllabus" element={<LatestSyllabusPage />} />
